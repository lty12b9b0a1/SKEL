...
def get_color(node: RedBlackTree | None) -> int:
...
def test_insert_and_search() -> bool:
    ...
    tree.insert(10)
    tree.insert(11)
    assert not (5 in tree or -6 in tree or -10 in tree or 13 in tree)
    # Found something not in there

    assert (11 in tree and 12 in tree and -8 in tree and 0 in tree)
